...
//    int color_type;
//
//    png_uint_16 red_channel;
//    png_uint_16 green_channel;
//    png_uint_16 blue_channel;
...
png_bytep Transform_Indexed_PNG2(png_bytep pixel, int target_color_type, int target_bit_depth);
